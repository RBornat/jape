 ...
 * @see JScrollPane
 */
public class KViewport extends JComponent implements Accessible
{
    /**
     * @see #getUIClassID
     * @see #readObject
    ...
    /**
      ...
      * @since 1.3
      */
//	static String prop = System.getProperty("com.apple.blitscroll");
    
	static private int sScrollMode = BLIT_SCROLL_MODE;
	...
	static
	{
        AccessController.doPrivileged(new PrivilegedAction()
		{
             public Object run()
			 {
				// Only put JViewPort into simple scroll mode if hwaccel is on.
				
				String glOn = System.getProperty("com.apple.hwaccel");
				if (glOn == null || glOn.equals("true"))
				{
					sScrollMode = SIMPLE_SCROLL_MODE;
				}
				
				String prop = System.getProperty("SIMPLE_SCROLL_MODE");
				if (prop != null && prop.equals("true"))
				{
					sScrollMode = SIMPLE_SCROLL_MODE;
				}
                
                prop = System.getProperty("BLIT_SCROLL_MODE");
				if (prop != null && prop.equals("true"))
				{
					sScrollMode = BLIT_SCROLL_MODE;
				}
                
                prop = System.getProperty("BACKINGSTORE_SCROLL_MODE");
				if (prop != null && prop.equals("true"))
				{
					sScrollMode = BACKINGSTORE_SCROLL_MODE;
				}                
    ...
    private int scrollMode  = sScrollMode;
    ...
    public void scrollRectToVisible(Rectangle contentRect) {
		...
		if (viewPosition.x != startX || viewPosition.y != startY) {
                    System.err.println("setViewPosition(viewPosition) -- viewPosition is "+viewPosition);
                    setViewPosition(viewPosition);
                    System.err.println("was that it?");
    ...
    public final void setBorder(Border border) {
        if (border != null) {
            throw new IllegalArgumentException("KViewport.setBorder() not supported");
        }
    }
    ...
    /**
      ...
      * @since 1.3
      */
	private int fScrollMode = sScrollMode;
...
//        scrollMode = mode;
    ...
    public boolean isBackingStoreEnabled() {
        return fScrollMode == BACKINGSTORE_SCROLL_MODE;
    }
	...
	if ((oldX != newX) || (oldY != newY)) {
		...
		com.apple.mrj.internal.awt.graphics.MacCompPeerGraphicsConfig.sDrawingFlusher.setProtectedSwingComponent(this);
		{
			Graphics g = getGraphics();
			flushViewDirtyRegion(g);
			// This calls setBounds(), and then repaint().
                        System.err.println("view.setLocation(newX, newY) (1) in setViewPosition -- newX="+newX+", newY="+newY);
		...
		com.apple.mrj.internal.awt.graphics.MacCompPeerGraphicsConfig.sDrawingFlusher.flushRootForComponent(this);
		...
		scrollUnderway = true;
		// This calls setBounds(), and then repaint().
                System.err.println("view.setLocation(newX, newY) (2) in setViewPosition -- newX="+newX+", newY="+newY);
		view.setLocation(newX, newY);
                System.err.println("was that it?");
		repaintAll = false;
	    }
    ...
    {        
        ...
        else
        {
            ...
            else
            {
                ...
                int bdx = blitTo.x - blitFrom.x;
                int bdy = blitTo.y - blitFrom.y;
                blitWindowGraphics(blitFrom.x, blitFrom.y, blitSize.width, blitSize.height, bdx, bdy);
                
                // Prepare the rest of the view; the part that has just been exposed.
...
/*
                ...
                // Prepare the rest of the view; the part that has just been exposed.
                boolean isDBE = false;//rm.isDoubleBufferingEnabled();BURKEY JCK COMPLIANCE BUT IGNORE isDoubleBufferingEnabled
                Rectangle r = view.getBounds().intersection(blitPaint);
                r.x -= view.getX();
                r.y -= view.getY();
...
*/
	...
	//	b = ((JComponent)parent)._bounds;
	    ...
	    //}
            ...
            System.err.println("oldClip.setBounds(clip) -- clip is"+clip);
