...
\textsc{button:} this allows you to attach a command to a label in a menu or a button on a panel. See \appxref{GUIlang} for information on the command language.
...
\textsc{initialise} \textit{variablename} \textit{value}: the variable named is assigned the value given. See the discussion of variables in \appxref{GUIlang}.
