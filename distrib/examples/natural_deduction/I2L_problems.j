...
CONJECTUREPANEL "Invalid conjectures"
    ...
    THEOREM IS Ëx.R(x)ÁËy.S(y) Ê Ëz.(R(z)ÁS(z))
    THEOREM IS actual j, S(j) Ê Ëx.(R(x)ÁS(x))
    THEOREM IS ‰x.R(x)¶‰y.S(y) Ê ‰z.(R(z)¶S(z))
    THEOREM IS Ëx.R(x) Ê ‰y.R(y)
    THEOREM IS ‰x.R(x) Ê Ëy.R(y)
...
CONJECTUREPANEL Conjectures
    ...
    THEOREM IS  EÁ(FÁ(GÁH)) Ê GÁ(FÁ(EÁH))
    ...
    THEOREM IS  Ëx.(R(x)ÁS(x)) Ê Ëy.R(y)ÁËz.S(z)
    THEOREM IS  Ëx.(R(x)ÁS(x)), Ëy.(S(y)ÁT(y)) Ê Ëz.(R(z)ÁT(z))
    THEOREM IS  Ëx.R(x)¶Ëy.S(y) Ê Ëz.(R(z)¶S(z))
    THEOREM IS  Ëx.(R(x)¶S(x)) Ê Ëy.R(y)¶Ëz.S(z)
    THEOREM IS  Ëx.(R(x)ÁS(x)), ‰y.R(y) Ê ‰z.S(z)
    THEOREM IS  ‰x.(R(x)¶S(x)) Ê ‰y.R(y)¶‰z.S(z)
    THEOREM IS  ‰x.R(x)Î‰y.S(y) Ê ‰z.(R(z)ÎS(z))
    THEOREM IS  ‰x.(R(x)ÎS(x)) Ê ‰y.R(y)Î‰z.S(z)
    THEOREM IS  actual j, Ëx.R(x) Ê ‰y.R(y)
    THEOREM IS  Ëx.R(x) Ê ¬‰y.¬R(y)
    THEOREM IS  ‰x.R(x) Ê ¬Ëy.¬R(y)
    THEOREM IS  ‰x.¬R(x) Ê ¬Ëy.R(y)
    THEOREM IS  Ëx.¬R(x) Ê ¬‰y.R(y)
    ...
    THEOREM IS actual j, actual k, ‰x.¬R(x) Ê ‰y.(R(y)ÁR(j)¶R(k))
