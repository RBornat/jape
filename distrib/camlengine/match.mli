 ...
 *)
val matchterm :
  bool -> term -> term -> (term, term) mapping list -> (term, term) mapping list
...
val match__ :
  bool -> term -> term -> (term, term) mapping -> (term, term) mapping option
...
val match3term : bool -> term -> term -> matchresult list -> matchresult list

val match3termvars :
  bool -> (term -> bool) -> term -> term -> matchresult list -> matchresult list

val match3 : bool -> term -> term -> matchresult -> matchresult option

val match3vars :
  bool -> (term -> bool) -> term -> term -> matchresult -> matchresult option
