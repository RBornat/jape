...
val catelim_string_of_universe :
...
val moveworldlabel :
  universe -> int * int -> int * int -> term -> universe option
...
val catelim_string_of_disproofstate :
...
val disproofstate_selections :
  disproofstate -> pos list * (pos * string list) list
...
val withdisproofselections :
  disproofstate -> pos list * (pos * string list) list -> disproofstate
...
val splitlink :
  universe -> int * int -> int * int -> int * int -> universe option
...
val disproof_start :
  facts -> prooftree -> path option -> element list -> disproofstate
...
val disproofstate_of_model :
  facts -> prooftree -> (seq * model) option -> disproofstate option
