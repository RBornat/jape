 ...
 * A <code>KScrollPane</code> manages a viewport, optional
 * vertical and horizontal scroll bars, and optional row and
 * column heading viewports.
 * You can find task-oriented documentation of <code>KScrollPane</code> in
 * <a
 ...
 *    <TR>
 *    <TD ALIGN="CENTER">
 *      <P ALIGN="CENTER"><IMG SRC="doc-files/KScrollPane-1.gif" WIDTH="256" HEIGHT="248" ALIGN="BOTTOM" BORDER="0">
 *    </TD>
 *    </TR>
 * </TABLE>
 * The <code>KViewport</code> provides a window,
 * or &quot;viewport&quot; onto a data 
 * source -- for example, a text file. That data source is the 
 * &quot;scrollable client&quot; (aka data model) displayed by the 
 * <code>KViewport</code> view.
 * A <code>KScrollPane</code> basically consists of <code>JScrollBar</code>s,
 * a <code>KViewport</code>, and the wiring between them,
 * as shown in the diagram at right. 
 * <p>
 * In addition to the scroll bars and viewport,
 * a <code>KScrollPane</code> can have a
 * column header and a row header. Each of these is a
 * <code>KViewport</code> object that
 ...
 * <a href="doc-files/Key-Index.html#KScrollPane">KScrollPane</a> 
 * key assignments.
 * <p>
 ...
 * @author Hans Muller
 */
public class KScrollPane extends JComponent implements ScrollPaneConstants, Accessible
{
     ...
     * The default is <code>KScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED</code>.
     ...
     * The default is <code>KScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED</code>.
     ...
     * @see #setColumnHeader
     */
    protected KViewport columnHeader;
    ...
    /**
     * Creates a <code>KScrollPane</code> that displays the view
    ...
    /**
     * Creates a <code>KScrollPane</code> that displays the
    ...
    /**
     * Creates an empty (no viewport view) <code>KScrollPane</code>
     * with specified 
     ...
     *		scrollbar policy
     */
    public KScrollPane(int vsbPolicy, int hsbPolicy) {
    ...
    /** 
     * Sets the layout manager for this <code>KScrollPane</code>.
    ...
    public void setLayout(LayoutManager layout) {
	    ...
	    String s = "layout of KScrollPane must be a ScrollPaneLayout";
     ...
     * <code>KScrollPane</code>.  For example,
     * the viewport's view, will cause a request to be queued that
     * will validate the <code>KScrollPane</code> and all its descendants.
     * 
     * @return true
     ...
     * Legal values are:
     * <ul>
     * <li>KScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED
     * <li>KScrollPane.VERTICAL_SCROLLBAR_NEVER
     * <li>KScrollPane.VERTICAL_SCROLLBAR_ALWAYS
     * </ul>
     *
     ...
     *        enum: VERTICAL_SCROLLBAR_AS_NEEDED KScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED
     *              VERTICAL_SCROLLBAR_NEVER KScrollPane.VERTICAL_SCROLLBAR_NEVER
     *              VERTICAL_SCROLLBAR_ALWAYS KScrollPane.VERTICAL_SCROLLBAR_ALWAYS
     */
     ...
     * The options are:<ul>
     * <li>KScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED
     * <li>KScrollPane.HORIZONTAL_SCROLLBAR_NEVER
     * <li>KScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS
     * </ul>
     * 
     * @param policy one of the three values listed above
     * @exception IllegalArgumentException if <code>policy</code> 
     ...
     *        enum: HORIZONTAL_SCROLLBAR_AS_NEEDED KScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED
     *              HORIZONTAL_SCROLLBAR_NEVER KScrollPane.HORIZONTAL_SCROLLBAR_NEVER
     *              HORIZONTAL_SCROLLBAR_ALWAYS KScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS
     */
     ...
     * set on the viewport directly, <code>KViewport</code> doesn't support 
     * the <code>JComponent</code> border property. 
     * Similarly setting the <code>KScrollPane</code>s
	...
	borderR.height -= insets.top + insets.bottom;
        ...
        boolean leftToRight = true; // SwingUtilities.isLeftToRight(this);

	/* If there's a visible column header remove the space it 
	 * needs from the top of borderR.  
	 */

	KViewport colHead = getColumnHeader();
	...
	KViewport rowHead = getRowHeader();
    ...
    /**
     * By default <code>KScrollPane</code> creates scrollbars
     * that are instances
     ...
     *
     * @see Scrollable
     * @see KScrollPane#createVerticalScrollBar
     * @see KScrollPane#createHorizontalScrollBar
     */
	...
	private boolean blockIncrementSet;
         ...
         * <li>KScrollPane.VERTICAL
         * <li>KScrollPane.HORIZONTAL
         * </ul>
         *
    ...
    /**
     * Returns a <code>KScrollPane.ScrollBar</code> by default.
     ...
     * This is usually unnecessary, as <code>KScrollPane</code> creates
    ...
    /**
     * Returns a <code>KScrollPane.ScrollBar</code> by default.  Subclasses
     ...
     * as <code>KScrollPane</code> creates vertical and
    ...
    /**
     * Returns a new <code>KViewport</code> by default. 
     * Used to create the
     ...
     * <code>KViewport</code>.
     *
     * @return a new <code>KViewport</code>
     */
    protected KViewport createViewport() {
        return new KViewport();
    }


    /**
     * Returns the current <code>KViewport</code>.
     *
     * @see #setViewport
     ...
     * 
     */
    public void setViewport(KViewport viewport) {
	KViewport old = getViewport();
     ...
     * that don't provide the view directly to the <code>KScrollPane</code>
     * constructor
     * should use this method to specify the scrollable child that's going
     * to be displayed in the scrollpane. For example:
     * <pre>
     * KScrollPane scrollpane = new KScrollPane();
     ...
     */
    public void setRowHeader(KViewport rowHeader) {
	KViewport old = getRowHeader();
     ...
     * @see #setColumnHeader
     */
    public KViewport getColumnHeader() {
        return columnHeader;
    }
     ...
     *    attribute: visualUpdate true
     */
    public void setColumnHeader(KViewport columnHeader) {
	KViewport old = getColumnHeader();
     ...
     * <ul>
     * <li>KScrollPane.LOWER_LEFT_CORNER
     * <li>KScrollPane.LOWER_RIGHT_CORNER
     * <li>KScrollPane.UPPER_LEFT_CORNER
     * <li>KScrollPane.UPPER_RIGHT_CORNER
     * <li>KScrollPane.LOWER_LEADING_CORNER
     * <li>KScrollPane.LOWER_TRAILING_CORNER
     * <li>KScrollPane.UPPER_LEADING_CORNER
     * <li>KScrollPane.UPPER_TRAILING_CORNER
     * </ul>
     *
    ...
    /**
     * Returns a string representation of this <code>KScrollPane</code>.
     * This method 
     ...
     * be <code>null</code>.
     * 
     * @return  a string representation of this <code>KScrollPane</code>.
     */
...
////////////////
    ...
    /**
     * Gets the AccessibleContext associated with this KScrollPane. 
     ...
     *         AccessibleContext of this KScrollPane
     */
     ...
     * <code>KScrollPane</code> class.  It provides an implementation of the 
    ...
    implements ChangeListener {
        ...
        protected KViewport viewPort = null;

        public void resetViewPort() {
            viewPort.removeChangeListener(this);
            viewPort = KScrollPane.this.getViewport();
        ...
        public void stateChanged(ChangeEvent e) {
            AccessibleContext ac = ((Accessible)KScrollPane.this).getAccessibleContext();
            if (ac != null) {
