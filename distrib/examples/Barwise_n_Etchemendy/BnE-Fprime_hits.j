...
HYPHIT Ë(x,y,z).P Ê C IS "Ë-E tac"
HYPHIT Ë(w,x,y,z).P Ê C IS "Ë-E tac"
HYPHIT ‰x.P Ê C IS "‰-E tac"
HYPHIT ‰(x,y).P Ê C IS "‰-E tac"
HYPHIT ‰(x,y,z).P Ê C IS "‰-E tac"
HYPHIT ‰(w,x,y,z).P Ê C IS "‰-E tac"

CONCHIT AÁB IS "Á-I"      
CONCHIT AÍB IS "Í-I"
CONCHIT A¶B IS "¶-I"
CONCHIT AÎB IS ALT (SEQ "Î-I(L)" hyp) (SEQ "Î-I(R)" hyp)
CONCHIT ¬A IS "¬-I"  
CONCHIT Ÿ IS "Ÿ-I"     
CONCHIT Ëx.P IS "Ë-I"  
CONCHIT Ë(x,y).P IS "Ë-I"  
CONCHIT Ë(x,y,z).P IS "Ë-I"  
CONCHIT Ë(w,x,y,z).P IS "Ë-I"  
