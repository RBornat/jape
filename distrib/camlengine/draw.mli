...
val setproofparams : Japeserver.displaystyle -> int -> unit

(* Tree/BoxStyle, line thickness *)

val debugstring_of_plan : ('a -> string) -> 'a plan -> string

val string_of_plan : 'a plan -> string
...
val textinfo_of_element :
  (element -> string) -> element -> textsize * textlayout

val textinfo_of_reason : reason -> textsize * textlayout

val textinfo_procrustes :
  int -> pos -> textsize * textlayout -> bool * (textsize * textlayout)
...
val planunwind :
  'a plan list * textbox -> 'a plan list -> 'a plan list * textbox

val planfold :
  ('a -> pos -> 'b plan) ->
  (pos -> 'b plan) ->
  pos * textbox * 'b plan list ->
  'a list ->
  pos * textbox * 'b plan list
