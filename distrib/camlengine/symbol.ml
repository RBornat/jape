...
let rec resetSymbols () =
  ...
  List.iter (enterclass (fun s->SHYID s))
    ["ABSTRACTION"; "AND"; "ARE"; "AUTOMATCH"; "AUTOUNIFY"; "BAG";
     ...
     "FONTS"; "FORCEDEF"; "FORMULA"; "FORMULAE"; "FRESH";
     "FROM"; "GIVENPANEL"; "HYPFRESH"; "HYPHIT"; "IDENTITY";
     "IMPCONCFRESH"; "IMPFRESH"; "IMPHYPFRESH"; "IN"; "INFER";
     "INFIX"; "INFIXC"; "INITIALLY"; "INITIALISE"; "IS"; "JUXTFIX";
     "KEYBOARD"; "LABEL"; "LABELS"; "LEFTFIX"; "LEFTWEAKEN"; "LIST";
     "MACRO"; "MENU"; "MENUKEY"; "MIDFIX"; "NOTIN"; "NOTONEOF";
     "NUMBER"; "OBJECT"; "OUTFIX"; "POSTFIX"; "PATCHALERT";
