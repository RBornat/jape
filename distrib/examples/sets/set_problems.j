...
CONJECTUREPANEL "Set Conjectures" IS
	...
	BUTTON "AêÉ" IS apply ForwardSubstHiding "rewrite ê Ç" "rewrite ê È"  LABEL
	BUTTON "ÉêB" IS apply ForwardSubstHiding "rewrite ê È" "rewrite ê Ç"  LABEL
	BUTTON "A=É" IS apply ForwardSubstHiding "rewrite = Ç" "rewrite = È"  LABEL
	BUTTON "É=B" IS apply ForwardSubstHiding "rewrite = È" "rewrite = Ç"  LABEL
END
