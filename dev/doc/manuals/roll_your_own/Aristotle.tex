...
The encodings are in \textj{Syllogisms (von Plato).jt}, \textj{Syllogisms (Roy Dyckhoff).jt}, and the files they reference in the \textj{examples/Aristotle/in symbols} folder.
