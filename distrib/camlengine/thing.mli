...
val freshGiven :
  ...
  cxt ->
  (name -> bool) ->
  cxt * (resnum list * resnum list) * seq
...
val compiletoprove :
  paraparam list * proviso list * seq list * seq ->
  (bool * proviso) list * seq list * seq
...
val wehavestructurerule :
  structurerule -> string list option -> (name -> bool) -> bool
