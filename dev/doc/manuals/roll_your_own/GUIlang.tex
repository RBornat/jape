...
hidehypprev & {\raggedright true, false} & {\raggedright false} & hide the application of identity rules (those declared by \textsc{structurerule identity}) which refer to the previous line in box display.\\
\hline
...
outerassumptionplural & any string & "assumptions" & justification to use, in box display, on first line of a proof if it contains more than one assumption. (Often changed to "premises".)\\ \hline
