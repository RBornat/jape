...
MENU Backward IS
	...
	ENTRY	"Ù intro (invents formulae)"	IS 
		WHEN 
			...
			(BackwardOnlyC Ù (SEQ (Singlearg "Ù intro" "Ù intro") fstep fstep) "Ù intro" "Ù")
...
MENU Forward IS
	...
	ENTRY	"Ù elim (constructive)"				IS Forward (QUOTE _P) (Noarg foodle) "Ù elim (constructive)" "Ù intro" Ù
