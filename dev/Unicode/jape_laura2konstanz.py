""" Python Character Mapping Codec
    ...
    For translating the Jape Laura encoding into Konstanz

    This is a butchered form of jape_laura -- it
    translates <=> <= => into <-> <- ->
    and (cdot) into (bullet)

    It is (only) used for translating the jnj theory 
    file from Laura into Konstanz
...
decoding_map.update({
	...
	0x0081: 0x21D0, # left arrow WAS 0x2190, #left_totalfun
	...
	0x008a: 0x2192, # arrow WAS 0x21d2, #double_totalfun
	0x008b: 0x2194, # <-> WAS 0x21d4, #double_relationarrow
	...
	0x00a4: 0x2022, # bullet WAS 0x2219, #cdot
	0x00a5: 0x2294, #lub
	0x00a6: 0x222a, #cup
