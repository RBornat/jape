...
\JPSFIG[scale=0.3]{session1}{A \Jape Session Window}
...
\JPSFIG[scale=0.55]{filemenu}{The \Jape{} {\tt File} menu}
\JPSFIG[scale=0.55]{theorydialogue1}{A \Jape theory dialogue (directory {\tt JAPEHOME/examples})}
\JPSFIG[scale=0.55]{theorydialogue2}{A \Jape theory dialogue (subdirectory \texttt{sequent\_calculus}}
...
If the proof rule that annotates a conclusion is selected and  \button{Backtrack} is used,
...
like  \FIGREF{Editconj} will appear.
...
Now press \button{Prove} on the conjectures panel, to start
the proof attempt:
...
In order to apply the $ÊË$ rule  \Jape has invented a variable that doesn't
appear anywhere in the proof, namely $m$. 
...
If you make a mistake whilst doing this you can remove a
selection made within a term by double-clicking the middle
button on it, and you can remove all term and text selections by
